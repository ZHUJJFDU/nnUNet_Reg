...
class RegnnUNetTrainer_5epochs(RegnnUNetTrainer):
...
class RegnnUNetTrainer_10epochs(RegnnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda')):
        """用于快速测试的10轮训练版本"""
...
class RegnnUNetTrainer_20epochs(RegnnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda')):
        """用于快速测试的20轮训练版本"""
...
class RegnnUNetTrainer_50epochs(RegnnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda')):
        """用于快速收敛的50轮训练版本"""
...
class RegnnUNetTrainer_100epochs(RegnnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda')):
        """标准训练轮数"""
...
class RegnnUNetTrainer_250epochs(RegnnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda')):
        """延长训练轮数"""
...
class RegnnUNetTrainer_500epochs(RegnnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda')):
        """长训练轮数"""
...
class RegnnUNetTrainer_1000epochs(RegnnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda')):
        """非常长的训练轮数"""
...
class RegnnUNetTrainer_CustomEpochs(RegnnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
